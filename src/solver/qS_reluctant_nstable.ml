(* GENERATED FILE. DO NOT EDIT.
   ...
   Variant: ReluctantNarrowingStable
   Configuration: first-discovery Reluctant Narrowing-Stable
   Adapter: extraction/reluctant/goblint_qsolver_reluctant_narrowing_stable.ml.in
   Regenerate with: make goblint-reluctant-solvers *)
(**
   Goblint callback adapter for the Reluctant Narrowing-Stable QSolver.

   This is a mutable implementation of the algorithm in
   [reluctant_narrowing_stable/QSOLVER_RELUCTANT_NARROWING_STABLE.md].
   The control operations at
   [@@CONTROL@@] are
...
module Make
  ...
  struct
    ...
    let trace_algorithm = "ReluctantNarrowingStable"
