...
let check_arguments () =
  ...
  if get_string "ana.osek.oil" <> "" && not (get_string "exp.privatization" = "protection-vesal" || get_string "exp.privatization" = "protection-old") then (set_string "exp.privatization" "protection-vesal"; info "oil requires protection-old/protection-vesal privatization")
