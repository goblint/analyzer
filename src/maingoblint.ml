...
let check_arguments () =
  ...
  if get_bool "ana.base.priv.protection.changes-only" && Option.is_none (List.find_opt (String.equal @@ get_string "ana.base.privatization") ["protection"; "protection-tid"; "protection-atomic"; "protection-read"; "protection-read-tid"; "protection-read-atomic"]) then
