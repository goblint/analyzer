...
let check_arguments () =
  ...
  if List.mem "memOutOfBounds" @@ get_string_list "ana.activated" && not @@ get_bool "ana.int.interval" then (set_bool "ana.int.interval" true; warn "The memOutOfBounds analysis enables ana.int.interval");
