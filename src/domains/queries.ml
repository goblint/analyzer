...
struct
  ...
  let order = function
    ...
    | Any (EvalMutexAttr _ ) -> 39
    | Any (InvariantGlobal _) -> 40
    | Any (MustProtectedVars _) -> 41
    | Any MayAccessed -> 42
  ...
  let hash_arg = function
    ...
    | Any (IsRecursiveMutex v) -> CilType.Varinfo.hash v
  ...
  let pretty () = function
    ...
    | Any (IsRecursiveMutex m) ->  Pretty.dprintf "IsRecursiveMutex _"
