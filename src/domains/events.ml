...
type t =
  ...
  | AssignAddrs of {lval: CilType.Lval.t; addrs: ValueDomain.AD.t}
...
let pretty () = function
  ...
  | AssignAddrs {lval; addrs} -> dprintf "AssignAddrs {lval=%a, addrs=%a}" CilType.Lval.pretty lval ValueDomain.AD.pretty addrs
