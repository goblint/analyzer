...
struct
  ...
  *)
  ...
  let widen x y =
    ...
    | (Int x, Address y)
    | (Address y, Int x) -> Address (AD.widen y (AD.join y (AD.of_int x))) (* TODO: remove join *)
    ...
    | (Int x, Thread y)
    | (Thread y, Int x) -> Thread (Threads.widen y (Threads.join y (Threads.top ()))) (* TODO: remove join *)
    | (Address x, Thread y)
    | (Thread y, Address x) -> Thread (Threads.widen y (Threads.join y (Threads.top ()))) (* TODO: remove join *)
    | (Mutex, Mutex) -> Mutex
