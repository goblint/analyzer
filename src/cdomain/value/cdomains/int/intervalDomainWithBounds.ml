...
module IntervalFunctor (Ints_t : BoundedIntOps): SOverflow with type int_t = Ints_t.t and type t = Ints_t.t_interval =
struct
...
module Interval = IntervalFunctor (Bounded(IntOps.BigIntOps))
module Interval32 = IntDomWithDefaultIkind (IntDomLifter (SOverflowUnlifter (IntervalFunctor (Bounded(IntOps.Int64Ops))))) (IntIkind)
