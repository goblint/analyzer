(** Two-phased top down solver that only keeps values at widening points and restores other values afterwards. *)
...
let _ =
  ...
  Selector.add_solver ("twpoint", (module WP : GenericGlobSolver));
