...
struct
  ...
  let change_d t new_env ~add ~del = VectorFunctor.timing_wrap "dimension change" (fun del -> change_d t new_env ~add:add ~del:del) del
  ...
  let add_vars t vars = VectorFunctor.timing_wrap "add_vars" (add_vars t) vars
  ...
  let drop_vars t vars = VectorFunctor.timing_wrap "drop_vars" (drop_vars t) vars

  let remove_vars t vars = drop_vars t vars ~del:false

  let remove_vars t vars = VectorFunctor.timing_wrap "remove_vars" (remove_vars t) vars
  ...
  let remove_filter t f = VectorFunctor.timing_wrap "remove_filter" (remove_filter t) f
  ...
  let keep_filter t f = VectorFunctor.timing_wrap "keep_filter" (keep_filter t) f
  ...
  let keep_vars t vs = VectorFunctor.timing_wrap "keep_vars" (keep_vars t) vs
