  ...
  *)
  ...
  struct
    ...
    let equal_exp ctx = function
      ...
      | `Float a, _ -> M.mywarn_each (M.LogEvent.may (M.EventType.Unknown ("EQUAL Float: unsupported!"))); false
      ...
      | `Free, b    -> true
      | a,b -> M.mywarn_each @@ (M.LogEvent.may (M.EventType.Unknown ("EQUAL? Unmatched case - assume true..."))); true
