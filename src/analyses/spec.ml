  ...
  *)
  ...
  struct
    ...
    let equal_exp ctx = function
      ...
      | `Float a, _ -> M.warn_each (M.Warning.may (M.WarnType.Unknown ("EQUAL Float: unsupported!"))); false
      ...
      | `Free, b    -> true
      | a,b -> M.warn_each @@ (M.Warning.may (M.WarnType.Unknown ("EQUAL? Unmatched case - assume true..."))); true
