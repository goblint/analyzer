...
struct
  ...
  let query ctx (type a) (q: a Queries.t): a Queries.result =
    ...
    | Queries.Priority "" ->
      ...
      Queries.ID.of_int IInt @@ IntOps.BigIntOps.of_int pry
    | Queries.Priority vname -> begin try Queries.ID.of_int IInt @@ IntOps.BigIntOps.of_int (Hashtbl.find offensivepriorities vname) with _ -> Queries.Result.top q end
