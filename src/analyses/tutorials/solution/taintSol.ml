...
struct
  ...
  let special man caller_state (lval: lval option) (f:varinfo) (arglist:exp list) : D.t =
  ...
  let combine man caller_state (callee_local:D.t) (lval:lval option) (f: fundec) (args: exp list): D.t =
