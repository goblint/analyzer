...
let c_descs_list: (string * LibraryDesc.t) list = LibraryDsl.[
    ...
    ("__builtin___strcpy_chk", special [__ "dest" [w]; __ "src" [r]] @@ fun dest src -> Strcpy { dest; src; n = None; });
    ...
    ("__builtin___strncpy_chk", special [__ "dest" [w]; __ "src" [r]; __ "n" []] @@ fun dest src n -> Strcpy { dest; src; n = Some n; });
    ...
    ("__builtin___strcat_chk", special [__ "dest" [w]; __ "src" [r]] @@ fun dest src -> Strcat { dest; src; n = None; });
    ...
    ("__builtin___strncat_chk", special [__ "dest" [w]; __ "src" [r]; __ "n" []] @@ fun dest src n -> Strcat { dest; src; n = Some n; });
