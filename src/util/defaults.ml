...
let _ = ()
      ...
      ; reg Experimental "exp.witness.thread.enabled" "false" "Construct non-standard thread-modular witnesses"
      ; reg Experimental "exp.witness.thread.singlethreaded" "false" "Add threadId data in singlethreaded mode"
