...
let _ = ()
      ...
      ; reg Experimental "exp.privatization"     "'mine-W'" "Which privatization to use? none/old/mutex-oplus/mutex-meet/global/global-read/global-vesal/mine/mine-nothread"
