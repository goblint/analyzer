...
let _ = ()
      ...
      ; reg Std "arinc_cfg_id"    "0"            "The ARINC cfg we want to consider here"
...
let _ = ()
      ...
      ; reg Analyses "ana.opt.hashcons"        "false"  "Should we try to save memory and speed up equality by hashconsing?"
