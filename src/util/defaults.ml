...
(* {4 category [Analyses]} *)
let _ = ()
      ; reg Analyses "ana.activated"  "['expRelation','base','threadid','threadflag','escape','mutex', 'mallocWrapper','octApron','loopTerm']"  "Lists of activated analyses in this phase."
      ...
      ; reg Analyses "ana.oct_no_uints"    "true"  "Use OctApron without tracking unsigned integers."
