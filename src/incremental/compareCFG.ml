...
let compareFun (module CfgOld : CfgForward) (module CfgNew : CfgBidir) fun1 fun2 =
  let same, diff = Stats2.time "compare-phase1" (fun () -> compareCfgs (module CfgOld) (module CfgNew) fun1 fun2) () in
  let unchanged, diffNodes1 = Stats2.time "compare-phase2" (fun () -> reexamine fun1 fun2 same diff (module CfgOld) (module CfgNew)) () in
