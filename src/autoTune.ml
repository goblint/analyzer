...
let notNeccessaryThreadAnalyses = notNeccessaryRaceAnalyses @ ["deadlock"; "maylocks"; "thread"; "threadid"; "threadJoins"; "threadJoinsPool"; "threadreturn"; "mhp"; "pthreadMutexType"; "mutexGhosts"]
