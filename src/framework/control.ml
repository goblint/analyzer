...
let get_spec () : (module Spec) =
  ...
  let module S1 = (val
            ...
            |> lift (get_bool "exp.widen-context" && neg get_bool "exp.side-entries") (module WidenContextLifter)
            |> lift (get_bool "exp.widen-context" && get_bool "exp.side-entries") (module WidenContextLifterSide)
