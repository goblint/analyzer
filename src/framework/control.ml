...
struct
  ...
  module Slvr  = (GlobSolverFromEqSolver (PostSolver.LiftStd (PostSolverArg) (Selector.Make) (PostSolverArg))) (EQSys) (LHT) (GHT)
  (* The comparator *)
    ...
    let solve_and_postprocess () =
      ...
      if get_string "comparesolver" <> "" then (
        let compare_with (module S2 : GenericEqBoxIncrSolver) =
          ...
          in
          let module S2' = (GlobSolverFromEqSolver (PostSolver.LiftStd (PostSolverArg) (S2) (PostSolverArg))) (EQSys) (LHT) (GHT) in
