...
./goblint --conf $conf $args --enable incremental.load --set save_run $base/$test-originalrun $source &> $base$test.after.incr.log
./goblint --conf $conf $args --set save_run $base/$test-incrementalrun $source &> $base$test.after.scratch.log
