...
GOBLINT_COMMAND = "./goblint --enable ana.sv-comp --enable exp.no-witness --disable ana.int.def_exc --enable ana.int.enums --enable ana.int.interval --sets solver td3 --disable exp.widen-context --enable exp.malloc-fail --enable exp.partition-arrays.enabled {code_filename}"
