...
struct
  ...
  let test_cast_to _ =
    ...
    assert_equal (I.of_int IUChar (of_int (210))) (I.cast_to ~kind:Unknown IUChar b1);
    assert_equal (I.of_int IUChar (of_int (-46))) (I.cast_to ~kind:Unknown IUChar b1);

    assert_equal (I.of_int IUInt128 (of_int 1234)) (I.cast_to ~kind:Unknown IUInt128 b1)
