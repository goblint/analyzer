// PARAM: --enable solvers.td3.narrow-sides.enabled --enable solvers.td3.narrow-sides.stable --enable ana.int.interval --enable ana.base.priv.protection.changes-only
#include <pthread.h>
#include <goblint.h>
#include <unistd.h>
