  $ goblint --set ana.activated[+] deadlock --set ana.race.graph-coloring greedy --enable warn.deterministic 27-self_deadlock.c
  ...
  [Warning][Race] Memory location g1 (race with conf. 110): (27-self_deadlock.c:5:5-5:7)
    Safe subset 1:
      ...
      write with [thread:[main, t1@27-self_deadlock.c:31:5-31:40], lock:{mutex1}] (conf. 110)  (exp: & g1) (27-self_deadlock.c:12:3-12:14)
    Safe subset 2:
      read with [lock:{mutex2}] (conf. 110)  (exp: & g1) (27-self_deadlock.c:21:3-21:14)
      read with [thread:[main, t2@27-self_deadlock.c:32:5-32:40], lock:{mutex2}] (conf. 110)  (exp: & g1) (27-self_deadlock.c:21:3-21:14)
      read with [thread:[main], mhp:{created={[main, t1@27-self_deadlock.c:31:5-31:40], [main, t2@27-self_deadlock.c:32:5-32:40], [main, {t1@27-self_deadlock.c:31:5-31:40}], [main, {t2@27-self_deadlock.c:32:5-32:40}]}}] (conf. 110)  (exp: & g1) (27-self_deadlock.c:35:5-35:49)
  [Warning][Race] Memory location g2 (race with conf. 110): (27-self_deadlock.c:5:9-5:11)
    Safe subset 1:
      ...
      write with [thread:[main, t2@27-self_deadlock.c:32:5-32:40], lock:{mutex2}] (conf. 110)  (exp: & g2) (27-self_deadlock.c:21:3-21:14)
    Safe subset 2:
      read with [lock:{mutex1}] (conf. 110)  (exp: & g2) (27-self_deadlock.c:12:3-12:14)
      read with [thread:[main, t1@27-self_deadlock.c:31:5-31:40], lock:{mutex1}] (conf. 110)  (exp: & g2) (27-self_deadlock.c:12:3-12:14)
      read with [thread:[main], mhp:{created={[main, t1@27-self_deadlock.c:31:5-31:40], [main, t2@27-self_deadlock.c:32:5-32:40], [main, {t1@27-self_deadlock.c:31:5-31:40}], [main, {t2@27-self_deadlock.c:32:5-32:40}]}}] (conf. 110)  (exp: & g2) (27-self_deadlock.c:35:5-35:49)
  ...
  [Warning][Deadlock] Locking order cycle:
    ...
    lock after: mutex1 with [thread:[main, t1@27-self_deadlock.c:31:5-31:40], lock:{mutex1}] (27-self_deadlock.c:11:3-11:30)
  [Warning][Deadlock] Locking order cycle:
  ...
  [Warning][Deadlock] Locking order cycle:
    ...
    lock after: mutex2 with [thread:[main, t2@27-self_deadlock.c:32:5-32:40], lock:{mutex2}] (27-self_deadlock.c:20:3-20:30)
