...
would unsoundly confirm the invariant.
  ...
  $ goblint --set dbg.level warning --disable warn.race --disable warn.integer --enable warn.deterministic --enable ana.sv-comp.functions --set witness.yaml.validate 52-mutex-ghost-basic-missing.yml --set ana.activated[+] mutexGhost --set ana.path_sens[+] threadflag --set ana.activated[+] threadJoins --set lib.activated[+] sv-comp --enable ana.int.interval --set colors never 52-mutex-ghost-basic-missing.c
  [Info][Deadcode] Logical lines of code (LLoC) summary:
    live: 28
    dead: 0
    total lines: 28
  [Warning][Witness] invariant unconfirmed: ghost_1 == 1 || g1 == 0 (52-mutex-ghost-basic-missing.c:43:5)
