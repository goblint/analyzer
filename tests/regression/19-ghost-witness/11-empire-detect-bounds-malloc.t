...
as a global pointer to a dynamically allocated integer.
  ...
  [Info][Deadcode] Logical lines of code (LLoC) summary:
    ...
    dead: 0
    total lines: 17
  [Info][Witness] phaseGhost: global ghost_a is only accessed by unique thread [main, fun@11-empire-detect-bounds-malloc.c:30:5-30:51] and has known lower and upper bounds
