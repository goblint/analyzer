...
inside the same mutex which main holds at the checked statement.
  ...
  [Info][Deadcode] Logical lines of code (LLoC) summary:
    ...
    dead: 0
    total lines: 12
  [Info][Witness] phaseGhost: global ghost_a is only accessed by unique thread [main, fun@08-sync-mutex-advance.c:21:5-21:51] and has known lower and upper bounds
