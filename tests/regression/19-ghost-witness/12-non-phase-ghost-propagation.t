Check that values of bounded, non-monotone phase ghost variables are propagated
across phase changes. Otherwise, the branch-local update in the new phase would
unsoundly confirm the invariant.
  ...
  [Info][Witness] phaseGhost: global ghost_non_phase is only accessed by unique thread [main] and has known lower and upper bounds
  [Info][Witness] phaseGhost: global ghost_phase is only accessed by unique thread [main, fun@12-non-phase-ghost-propagation.c:31:5-31:51] and has known lower and upper bounds
