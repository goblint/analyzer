...
would unsoundly confirm the invariant.
  ...
  $ goblint --set dbg.level warning --disable warn.race --disable warn.integer --enable warn.deterministic --enable ana.sv-comp.functions --set witness.yaml.validate 51-mutex-ghost-basic-wrong.yml --set ana.activated[+] mutexGhost --set ana.path_sens[+] threadflag --set ana.activated[+] threadJoins --set lib.activated[+] sv-comp --enable ana.int.interval --set colors never 51-mutex-ghost-basic-wrong.c
  [Info][Deadcode] Logical lines of code (LLoC) summary:
    live: 28
    dead: 0
    total lines: 28
  [Warning][Witness] invariant unconfirmed: ghost_1 == 1 || g1 == 0 (51-mutex-ghost-basic-wrong.c:43:5)
