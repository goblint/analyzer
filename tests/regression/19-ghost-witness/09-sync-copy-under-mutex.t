...
because ghost_a is accessed by multiple unique threads.
  ...
  [Info][Deadcode] Logical lines of code (LLoC) summary:
    ...
    dead: 0
    total lines: 13
  [Info][Witness] phaseGhost: global ghost_a is only accessed by unique thread [main, fun@09-sync-copy-under-mutex.c:20:5-20:51] and has known lower and upper bounds
