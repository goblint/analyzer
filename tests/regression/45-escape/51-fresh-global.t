  ...
  [Warning][Race] Memory location (alloc@sid:$SID@tid:main) (race with conf. 110): (51-fresh-global.c:25:7-25:31)
    write with [lock:{A}, threadflag:(MT mode:Multithreaded (other), bool:true)] (conf. 110)  (exp: & *i) (51-fresh-global.c:10:3-10:10)
    write with [threadflag:(MT mode:Multithreaded (main), bool:true), thread:main] (conf. 110)  (exp: & *i) (51-fresh-global.c:27:3-27:9)
