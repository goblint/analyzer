Disable info messages because race summary contains (safe) memory location count, which is different on Linux and OSX.
  ...
  [Warning][Race] Memory location (struct s).datum (race with conf. 100):
    write with thread:[main, t_fun@16-type_rc.c:35:3-35:37#top] (conf. 100)  (exp: & s->datum) (16-type_rc.c:21:3-21:15)
    write with [mhp:{created={[main, t_fun@16-type_rc.c:35:3-35:37#top]}}, thread:[main]] (conf. 100)  (exp: & *d) (16-type_rc.c:36:3-36:9)
