// SKIP PARAM: --enable ana.int.interval_set --set ana.base.arrays.domain partitioned --set ana.base.partition-arrays.keep-expr "last" --set ana.activated[+] apron --set sem.int.signed_overflow assume_none
#include <goblint.h>
