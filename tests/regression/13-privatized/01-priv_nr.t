`protection` privatization:
  ...
  $ goblint --enable witness.yaml.enabled --disable witness.invariant.other --set ana.base.privatization protection 01-priv_nr.c --trace global_inits --trace set --trace con --trace update_offset --trace eval --trace evalint --trace get
