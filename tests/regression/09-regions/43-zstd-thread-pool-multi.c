// PARAM: --set ana.activated[+] symb_locks --set ana.activated[+] regionNonEscape --set lib.activated[+] zstd --disable ana.race.free
// disabled free races because unsound: https://github.com/goblint/analyzer/pull/978
// copied from 06 35-zstd-thread-pool-multi.c; change: regionNonEscape instead of mallocFresh
