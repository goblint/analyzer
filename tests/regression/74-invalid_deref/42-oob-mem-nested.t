  ...
  [Error][Behavior > Undefined > MemoryOutOfBoundsAccess][CWE-823] Size of pointer is 4 (in bytes). It is offset by -4 (in bytes) due to pointer arithmetic. Memory out-of-bounds access must occur (42-oob-mem-nested.c:17:3-17:19)
  ...
  [Error][Behavior > Undefined > MemoryOutOfBoundsAccess][CWE-823] Size of pointer is 4 (in bytes). It is offset by -4 (in bytes) due to pointer arithmetic. Memory out-of-bounds access must occur (42-oob-mem-nested.c:21:3-21:23)
