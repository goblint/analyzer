  $ goblint --set ana.activated[+] memOutOfBounds --enable ana.int.interval 01-oob-heap-simple.c
  ...
  $ goblint --set ana.activated[+] memOutOfBounds --enable ana.int.interval --enable dbg.full-output 01-oob-heap-simple.c
  Option warning: The memOutOfBounds analysis enables cil.addNestedScopeAttr.
