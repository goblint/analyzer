// PARAM: --enable modular --set ana.modular.funs "['freadptrinc', 'freadseek']" --set ana.activated[+] "'modular_queries'" --set ana.activated[+] "'is_modular'" --set ana.activated[+] "'written'" --set ana.activated[+] "'read'"  --set ana.activated[+] "'used_globals'"
struct _IO_FILE
{
	char *_IO_read_ptr;
};
