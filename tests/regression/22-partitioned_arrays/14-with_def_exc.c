// PARAM: --sets solver td3 --enable ana.int.def_exc --disable exp.fast_global_inits  --enable exp.partition-arrays.enabled  --set ana.activated "['base','baseflag','expRelation']"
int main(void) {
