  ...
  [Warning][Race] Memory location t.s.data (race with conf. 110): (86-distribute-fields-3.c:15:10-15:11)
    ...
    write with [thread:[main], mhp:{created={[main, t_fun@86-distribute-fields-3.c:24:3-24:40]}}] (conf. 110)  (exp: & t) (86-distribute-fields-3.c:26:3-26:9)
  ...
  <   write with [thread:[main], mhp:{created={[main, t_fun@86-distribute-fields-3.c:24:3-24:40]}}] (conf. 110)  (exp: & t) (86-distribute-fields-3.c:26:3-26:9)
  ---
  >   write with [thread:[main, t_fun@86-distribute-fields-3.c:24:3-24:40#⊤], mhp:{tid=[main, t_fun@86-distribute-fields-3.c:24:3-24:40#⊤]}] (conf. 110)  (exp: & t.s.data) (86-distribute-fields-3.c:18:3-18:15)
  >   write with [thread:[main], mhp:{tid=[main]; created={[main, t_fun@86-distribute-fields-3.c:24:3-24:40#⊤]}}] (conf. 110)  (exp: & t) (86-distribute-fields-3.c:26:3-26:9)
  10c10
  <   write with [thread:[main], mhp:{created={[main, t_fun@86-distribute-fields-3.c:24:3-24:40]}}] (conf. 110)  (exp: & t) (86-distribute-fields-3.c:26:3-26:9)
  ---
  >   write with [thread:[main], mhp:{tid=[main]; created={[main, t_fun@86-distribute-fields-3.c:24:3-24:40#⊤]}}] (conf. 110)  (exp: & t) (86-distribute-fields-3.c:26:3-26:9)
