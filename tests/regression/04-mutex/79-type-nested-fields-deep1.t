  ...
  [Warning][Race] Memory location (struct U).t.s.field (race with conf. 100):
    ...
    write with thread:[main], mhp:{created={[main, t_fun@79-type-nested-fields-deep1.c:42:3-42:40]}} (conf. 100)  (exp: & tmp->t.s.field) (79-type-nested-fields-deep1.c:43:3-43:24)
  ...
  <   write with thread:[main], mhp:{created={[main, t_fun@79-type-nested-fields-deep1.c:42:3-42:40]}} (conf. 100)  (exp: & tmp->t.s.field) (79-type-nested-fields-deep1.c:43:3-43:24)
  ---
  >   write with thread:[main, t_fun@79-type-nested-fields-deep1.c:42:3-42:40#⊤], mhp:{tid=[main, t_fun@79-type-nested-fields-deep1.c:42:3-42:40#⊤]} (conf. 100)  (exp: & tmp->field) (79-type-nested-fields-deep1.c:36:3-36:20)
  >   write with thread:[main], mhp:{tid=[main]; created={[main, t_fun@79-type-nested-fields-deep1.c:42:3-42:40#⊤]}} (conf. 100)  (exp: & tmp->t.s.field) (79-type-nested-fields-deep1.c:43:3-43:24)
  12c12
  <   write with thread:[main, t_fun@79-type-nested-fields-deep1.c:42:3-42:40] (conf. 100)  (exp: & tmp->field) (79-type-nested-fields-deep1.c:36:3-36:20)
  ---
  >   write with thread:[main, t_fun@79-type-nested-fields-deep1.c:42:3-42:40#⊤], mhp:{tid=[main, t_fun@79-type-nested-fields-deep1.c:42:3-42:40#⊤]} (conf. 100)  (exp: & tmp->field) (79-type-nested-fields-deep1.c:36:3-36:20)
