  ...
  [Warning][Race] Memory location t.s.data (race with conf. 110): (85-distribute-fields-2.c:15:10-15:11)
    ...
    write with thread:[main], mhp:{created={[main, t_fun@85-distribute-fields-2.c:24:3-24:40]}} (conf. 110)  (exp: & t.s) (85-distribute-fields-2.c:26:3-26:11)
  ...
  <   write with thread:[main], mhp:{created={[main, t_fun@85-distribute-fields-2.c:24:3-24:40]}} (conf. 110)  (exp: & t.s) (85-distribute-fields-2.c:26:3-26:11)
  ---
  >   write with thread:[main, t_fun@85-distribute-fields-2.c:24:3-24:40#⊤], mhp:{tid=[main, t_fun@85-distribute-fields-2.c:24:3-24:40#⊤]} (conf. 110)  (exp: & t.s.data) (85-distribute-fields-2.c:18:3-18:15)
  >   write with thread:[main], mhp:{tid=[main]; created={[main, t_fun@85-distribute-fields-2.c:24:3-24:40#⊤]}} (conf. 110)  (exp: & t.s) (85-distribute-fields-2.c:26:3-26:11)
  10c10
  <   write with thread:[main], mhp:{created={[main, t_fun@85-distribute-fields-2.c:24:3-24:40]}} (conf. 110)  (exp: & t.s) (85-distribute-fields-2.c:26:3-26:11)
  ---
  >   write with thread:[main], mhp:{tid=[main]; created={[main, t_fun@85-distribute-fields-2.c:24:3-24:40#⊤]}} (conf. 110)  (exp: & t.s) (85-distribute-fields-2.c:26:3-26:11)
