  ...
  [Warning][Race] Memory location (struct T).s.field (race with conf. 100):
    ...
    write with [mhp:{created={[main, t_fun@90-distribute-fields-type-1.c:37:3-37:40#top]}}, thread:[main]] (conf. 100)  (exp: & tmp->s) (90-distribute-fields-type-1.c:39:3-39:17)
