  ...
  [Warning][Race] Memory location s.data (race with conf. 110): (84-distribute-fields-1.c:9:10-9:11)
    ...
    write with [thread:[main], mhp:{created={[main, t_fun@84-distribute-fields-1.c:18:3-18:40]}}] (conf. 110)  (exp: & s) (84-distribute-fields-1.c:20:3-20:9)
  ...
  <   write with [thread:[main], mhp:{created={[main, t_fun@84-distribute-fields-1.c:18:3-18:40]}}] (conf. 110)  (exp: & s) (84-distribute-fields-1.c:20:3-20:9)
  ---
  >   write with [thread:[main, t_fun@84-distribute-fields-1.c:18:3-18:40#⊤], mhp:{tid=[main, t_fun@84-distribute-fields-1.c:18:3-18:40#⊤]}] (conf. 110)  (exp: & s.data) (84-distribute-fields-1.c:12:3-12:13)
  >   write with [thread:[main], mhp:{tid=[main]; created={[main, t_fun@84-distribute-fields-1.c:18:3-18:40#⊤]}}] (conf. 110)  (exp: & s) (84-distribute-fields-1.c:20:3-20:9)
  10c10
  <   write with [thread:[main], mhp:{created={[main, t_fun@84-distribute-fields-1.c:18:3-18:40]}}] (conf. 110)  (exp: & s) (84-distribute-fields-1.c:20:3-20:9)
  ---
  >   write with [thread:[main], mhp:{tid=[main]; created={[main, t_fun@84-distribute-fields-1.c:18:3-18:40#⊤]}}] (conf. 110)  (exp: & s) (84-distribute-fields-1.c:20:3-20:9)
