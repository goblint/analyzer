  ...
  [Warning][Race] Memory location myglobal (race with conf. 110): (16-atomic_priv.c:8:5-8:17)
    write with thread:[main, t_fun@16-atomic_priv.c:23:3-23:40], lock:{[__VERIFIER_atomic]} (conf. 110)  (exp: & myglobal) (16-atomic_priv.c:13:3-13:13)
    write with thread:[main, t_fun@16-atomic_priv.c:23:3-23:40], lock:{[__VERIFIER_atomic]} (conf. 110)  (exp: & myglobal) (16-atomic_priv.c:15:3-15:13)
    read with thread:[main], mhp:{created={[main, t_fun@16-atomic_priv.c:23:3-23:40]}} (conf. 110)  (exp: & myglobal) (16-atomic_priv.c:24:3-24:33)
