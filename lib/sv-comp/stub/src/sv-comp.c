...
__VERIFIER_nondet2(char*, charp)
__VERIFIER_nondet2(const char*, const_char_pointer)
__VERIFIER_nondet2(__SIZE_TYPE__, size_t)
// missing pthread_t
// missing sector_t
__VERIFIER_nondet(short)
__VERIFIER_nondet2(unsigned int, u32)
__VERIFIER_nondet2(unsigned short int, u16)
__VERIFIER_nondet2(unsigned char, u8)
__VERIFIER_nondet2(unsigned char, unsigned_char)
