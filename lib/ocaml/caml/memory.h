...
#define CAMLxparam1(x) __goblint_caml_param(&x)

#define CAMLxparam2(x, y) __goblint_caml_param(&x, &y)

#define CAMLxparam3(x, y, z) __goblint_caml_param(&x, &y, &z)

#define CAMLxparam4(x, y, z, t) __goblint_caml_param(&x, &y, &z, &t)

#define CAMLxparam5(x, y, z, t, u) __goblint_caml_param(&x, &y, &z, &t, &u)
...
#define CAMLlocal2(x, y) value x = Val_unit, y = Val_unit; __goblint_caml_param(&x, &y)

#define CAMLlocal3(x, y, z) value x = Val_unit, y = Val_unit, z = Val_unit; __goblint_caml_param(&x, &y, &z)

#define CAMLlocal4(x, y, z, t) value x = Val_unit, y = Val_unit, z = Val_unit, t = Val_unit; __goblint_caml_param(&x, &y, &z, &t)

#define CAMLlocal5(x, y, z, t, u) value x = Val_unit, y = Val_unit, z = Val_unit, t = Val_unit, u = Val_unit; __goblint_caml_param(&x, &y, &z, &t, &u)

// TODO: Redefine the paramN and localN macros.
...
#define CAMLdrop __goblint_caml_drop()
...
#define Begin_roots1(r0) __goblint_caml_begin_roots(&r0)

#define Begin_roots2(r0, r1) __goblint_caml_begin_roots(&r0, &r1)

#define Begin_roots3(r0, r1, r2) __goblint_caml_begin_roots(&r0, &r1, &r2)

#define Begin_roots4(r0, r1, r2, r3) __goblint_caml_begin_roots(&r0, &r1, &r2, &r3)

#define Begin_roots5(r0, r1, r2, r3, r4) __goblint_caml_begin_roots(&r0, &r1, &r2, &r3, &r4)
